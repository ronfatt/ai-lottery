...
export const TechLaunchView: React.FC = () => {
  ...
  return (
    <div className="space-y-10 max-w-7xl mx-auto pb-16 font-sans">
      ...
      <div className="rounded-3xl bg-[#090D14] border-2 border-cyan-500/50 backdrop-blur-2xl shadow-[0_0_60px_rgba(0,229,255,0.2)] overflow-hidden relative group">
        ...
        <div className="h-64 sm:h-80 w-full relative overflow-hidden bg-[#06090E]">
          ...
          <div className="absolute top-4 left-4 flex items-center gap-2">
            <span className="px-3 py-1 rounded-full text-xs font-mono font-black bg-cyan-400 text-black uppercase flex items-center gap-1.5 shadow-lg shadow-cyan-400/30">
              <Sparkles className="w-3.5 h-3.5" />
              <span>🚀 NEW CATEGORY // 科技新品发布推演</span>
            </span>
            <span className="px-2.5 py-1 rounded-full text-[10px] font-mono font-bold bg-black/70 text-cyan-300 border border-cyan-500/30 backdrop-blur-md">
              DEMO DATA // 模拟推演
            </span>
          </div>

          <div className="absolute top-4 right-4 hidden sm:flex items-center gap-2 font-mono text-xs">
            <span className="px-3 py-1 rounded-xl bg-black/80 text-lime-400 border border-lime-400/40 backdrop-blur-md font-bold flex items-center gap-1.5">
          ...
          <div className="absolute bottom-4 left-4 sm:left-8 right-4 sm:right-8 space-y-1.5">
            ...
            <p className="text-xs sm:text-sm font-mono text-metal-300 max-w-3xl">
        ...
        <div className="p-6 sm:p-8 bg-[#0B101A] border-t border-white/10 grid grid-cols-2 sm:grid-cols-4 gap-4 font-mono text-xs">
          <div className="p-3.5 rounded-2xl bg-surface-100 border border-white/5">
            <span className="text-metal-400 text-[10px] block uppercase">推演周期</span>
            <span className="text-white font-bold text-sm sm:text-base">2026年 10月01–31日</span>
          </div>

          <div className="p-3.5 rounded-2xl bg-surface-100 border border-white/5">
            <span className="text-metal-400 text-[10px] block uppercase">全网已锁推演</span>
            <span className="text-cyan-400 font-black text-sm sm:text-base">84,219 次</span>
          </div>

          <div className="p-3.5 rounded-2xl bg-surface-100 border border-white/5">
            <span className="text-metal-400 text-[10px] block uppercase">参与极客玩家</span>
            <span className="text-white font-bold text-sm sm:text-base">23,481 位</span>
          </div>

          <div className="p-3.5 rounded-2xl bg-surface-100 border border-cyan-500/30">
            <span className="text-cyan-400 text-[10px] block uppercase font-bold">追踪品牌阵容</span>
            <span className="text-cyan-400 font-black text-sm sm:text-base">12 大全球品牌</span>
          </div>
        </div>
        ...
        <div className="p-6 sm:p-8 pt-0 bg-[#0B101A] flex flex-wrap items-center gap-3 font-mono text-xs">
          <a
            ...
            className="px-6 py-3 rounded-xl bg-cyan-400 hover:bg-cyan-300 text-black font-black uppercase tracking-wider flex items-center gap-2 transition-all shadow-[0_0_30px_rgba(0,229,255,0.4)]"
          >
          ...
          <a
            ...
            className="px-5 py-3 rounded-xl bg-surface-200 hover:bg-surface-300 text-white border border-white/10 font-bold transition-all"
          >
          ...
          <button
            ...
            className="px-4 py-3 rounded-xl bg-surface-200 hover:bg-surface-300 text-cyan-300 border border-cyan-500/30 font-bold flex items-center gap-1.5 ml-auto"
          >
      ...
      {/* 2. CRITICAL VERIFICATION RULE CARD (Section 04) */}
      <div className="p-6 sm:p-8 rounded-3xl bg-surface-100/95 border-2 border-lime-400/60 backdrop-blur-xl shadow-glass-card space-y-4 font-mono text-xs">
        <div className="flex items-center gap-3 pb-3 border-b border-white/10">
          ...
          <div>
            ...
            <span className="text-[11px] text-metal-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
          <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 space-y-2">
            ...
            <ul className="space-y-1 text-metal-200 text-[11px]">
          ...
          <div className="p-4 rounded-2xl bg-red-500/10 border border-red-500/30 space-y-2">
            ...
            <ul className="space-y-1 text-metal-300 text-[11px]">
        ...
        <div className="p-3 rounded-xl bg-surface-200/80 border border-white/5 flex items-center justify-between text-[11px] text-metal-300">
          <span>最终结算状态：<strong className="text-lime-400">OFFICIAL LAUNCH VERIFIED (官方发布核验)</strong></span>
          <span className="text-cyan-400">全量写入密码学存证账本</span>
        </div>
      </div>

      {/* 3. TODAY'S TECH CALL (Daily Retention Section 27) */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 rounded text-[9px] font-bold bg-cyan-400 text-black uppercase">
                TODAY'S TECH CALL // 每日极客推演
              </span>
              <span className="text-[10px] text-metal-400">剩余 18:42:10</span>
            </div>
            <h4 className="font-display font-black text-lg text-white">
              vivo 会在未来 48 小时内官宣 X200 系列的具体发布会日期吗？
            </h4>
            <p className="text-[11px] text-metal-300">
              当前群体共识：YES (68%) · 命中可获得 +150 XP · Tech IQ +4
            </p>
          </div>
        </div>
          ...
          <button
            ...
            className={`flex-1 md:flex-initial px-6 py-3 rounded-xl font-bold uppercase transition-all ${
              dailyCallChoice === 'YES'
                ...
                : 'bg-surface-200 hover:bg-surface-300 text-white border border-white/10'
            }`}
          >
            <span>YES (会官宣)</span>
          </button>
      ...
      {/* 4. GAME MODE 01 — BRAND LAUNCH (Section 05 & 06) */}
      <div id="brand-selection" className="p-6 sm:p-8 rounded-3xl bg-surface-100/90 border border-white/15 backdrop-blur-xl shadow-glass-card space-y-6 font-mono text-xs">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-white/10 gap-4">
          <div>
            ...
            <p className="text-xs text-metal-300 mt-0.5">
              挑选最多 3 个您认为将在 2026年 10月 正式发布新手机的品牌（已选 {selectedBrands.length} / 3）：
            </p>
          </div>

          <div className="flex items-center gap-3">
            <span className="px-3 py-1.5 rounded-xl bg-surface-200 text-cyan-400 font-bold border border-cyan-500/30">
            ...
            return (
              <div
                ...
                className={`p-4 rounded-2xl border transition-all cursor-pointer flex flex-col justify-between space-y-3 ${
                  isSelected
                    ? 'bg-cyan-500/15 border-cyan-400 shadow-[0_0_25px_rgba(0,229,255,0.25)] scale-[1.02]'
                    : 'bg-surface-200/90 border-white/5 hover:border-white/20'
                }`}
              >
                <div className="flex items-start justify-between">
                  <div>
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[9px] text-metal-400">({brand.country})</span>
                    </div>
                    <span className="text-[10px] text-metal-300 line-clamp-1 mt-0.5">{brand.rumouredModels}</span>
                  </div>

                  <div className={`w-5 h-5 rounded-lg flex items-center justify-center font-bold text-xs ${
                    isSelected ? 'bg-cyan-400 text-black' : 'bg-surface-300 text-metal-400'
                  }`}>
                    {isSelected ? '✓' : '+'}
                  </div>
                </div>
                ...
                <div className="pt-2 border-t border-white/5 flex items-center justify-between text-[10px]">
                  <span className="text-metal-400">群体支持率：</span>
                  <span className={`font-bold ${isSelected ? 'text-cyan-400' : 'text-metal-200'}`}>
                    {brand.communityPickRate}%
                  </span>
                </div>

                {brand.tag && (
                  <span className="px-2 py-0.5 rounded text-[8px] bg-cyan-400/20 text-cyan-300 font-bold border border-cyan-400/30 self-start">
                    {brand.tag}
                  </span>
                )}
              </div>
      ...
      {/* 5. GAME MODE 02 & EXACT DATE (Section 07 & 08) */}
      <div className="p-6 sm:p-8 rounded-3xl bg-surface-100/90 border border-white/15 backdrop-blur-xl shadow-glass-card space-y-6 font-mono text-xs">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl font-bold transition-all ${
                windowBrand === b
                  ...
                  : 'bg-surface-200 text-metal-300 border border-white/10 hover:text-white'
              }`}
            >
              {b}
            </button>
            ...
            <button
              ...
              className={`p-4 rounded-2xl border text-left transition-all ${
                selectedWindow === win.id
                  ...
                  : 'bg-surface-200/80 border-white/5 text-metal-300 hover:border-white/20'
              }`}
            >
              <span className="font-bold text-xs block text-white">{win.label}</span>
              <span className="text-[10px] text-cyan-400 font-bold block mt-1">{win.pickRate} 群体支持</span>
              {win.tag && (
                <span className="px-1.5 py-0.2 rounded text-[8px] bg-cyan-400/20 text-cyan-300 font-bold border border-cyan-400/30 mt-2 inline-block">
                  {win.tag}
                </span>
              )}
            </button>
        ...
        {/* Advanced Exact Date Picker (Oct 1–31) */}
        <div className="p-5 rounded-2xl bg-surface-50 border border-white/5 space-y-3">
              ...
              <button
                ...
                className={`py-2 rounded-lg font-bold text-xs transition-all ${
                  exactDate === d
                    ...
                    : 'bg-surface-200 text-metal-300 hover:bg-surface-300 hover:text-white'
                }`}
              >
                {d}
              </button>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[10px] text-metal-400 pt-2 border-t border-white/5">
            <div>精确命中 (Exact)：<strong className="text-lime-400">+800 XP</strong></div>
            <div>误差 ±1 天：<strong className="text-cyan-400">+500 XP</strong></div>
            <div>误差 ±3 天：<strong className="text-white">+250 XP</strong></div>
            <div>跨周参与：<strong className="text-metal-300">+50 参与 XP</strong></div>
          </div>
        </div>
        ...
        <div className="flex justify-end">
          <button
            ...
            className={`px-6 py-3 rounded-xl font-bold uppercase transition-all flex items-center gap-2 ${
              dateLocked
                ? 'bg-cyan-400/20 text-cyan-300 border border-cyan-500/40'
      ...
      {/* 6. GAME MODES 03–08 GRID (Battles, Category, Foldable, Price, Count) */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        
        {/* Mode 03: Brand Battle (Who Announces First?) */}
        <div className="p-6 rounded-3xl bg-surface-100/90 border border-white/15 backdrop-blur-xl space-y-4 font-mono text-xs shadow-glass-card">
          <div className="flex items-center gap-2 text-cyan-400 font-bold pb-2 border-b border-white/10">
            <Zap className="w-4 h-4" />
            <span>GAME MODE 03 // 谁先官宣？(WHO ANNOUNCES FIRST?)</span>
          </div>

          {/* Battle 1: OPPO vs vivo */}
          <div className="p-3.5 rounded-2xl bg-surface-200/80 border border-white/5 space-y-2">
            <div className="flex justify-between text-metal-400 text-[10px]">
              <span>对决 01 · 影像旗舰先锋战</span>
              <span className="text-cyan-400">群体率：OPPO 58% vs vivo 42%</span>
            </div>
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => setBattle1('OPPO')}
                className={`py-2.5 rounded-xl font-bold transition-all ${
                  battle1 === 'OPPO' ? 'bg-cyan-400 text-black font-black' : 'bg-surface-100 text-metal-300'
                }`}
              >
                OPPO 率先官宣
              </button>
              <button
                ...
                className={`py-2.5 rounded-xl font-bold transition-all ${
                  battle1 === 'vivo' ? 'bg-cyan-400 text-black font-black' : 'bg-surface-100 text-metal-300'
                }`}
              >
                vivo 率先官宣
              </button>
          ...
          {/* Battle 2: Xiaomi vs HONOR */}
          <div className="p-3.5 rounded-2xl bg-surface-200/80 border border-white/5 space-y-2">
            <div className="flex justify-between text-metal-400 text-[10px]">
              <span>对决 02 · 骁龙旗舰首发战</span>
              <span className="text-cyan-400">群体率：Xiaomi 51% vs HONOR 49%</span>
            </div>
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => setBattle2('Xiaomi')}
                className={`py-2.5 rounded-xl font-bold transition-all ${
                  battle2 === 'Xiaomi' ? 'bg-cyan-400 text-black font-black' : 'bg-surface-100 text-metal-300'
                }`}
              >
                Xiaomi 率先官宣
              </button>
              <button
                ...
                className={`py-2.5 rounded-xl font-bold transition-all ${
                  battle2 === 'HONOR' ? 'bg-cyan-400 text-black font-black' : 'bg-surface-100 text-metal-300'
                }`}
              >
                HONOR 率先官宣
              </button>
          ...
          {/* Battle 3: OnePlus vs realme */}
          <div className="p-3.5 rounded-2xl bg-surface-200/80 border border-white/5 space-y-2">
            <div className="flex justify-between text-metal-400 text-[10px]">
              <span>对决 03 · 性能极客对决</span>
              <span className="text-cyan-400">群体率：OnePlus 62% vs realme 38%</span>
            </div>
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => setBattle3('OnePlus')}
                className={`py-2.5 rounded-xl font-bold transition-all ${
                  battle3 === 'OnePlus' ? 'bg-cyan-400 text-black font-black' : 'bg-surface-100 text-metal-300'
                }`}
              >
                OnePlus 率先发布
              </button>
              <button
                ...
                className={`py-2.5 rounded-xl font-bold transition-all ${
                  battle3 === 'realme' ? 'bg-cyan-400 text-black font-black' : 'bg-surface-100 text-metal-300'
                }`}
              >
                realme 率先发布
              </button>
        ...
        <div className="space-y-4">
          ...
          {/* Mode 04: How Many Brands? */}
          <div className="p-5 rounded-3xl bg-surface-100/90 border border-white/15 font-mono text-xs space-y-2.5">
            ...
            <div className="grid grid-cols-4 gap-2">
              {(['0-2', '3-4', '5-6', '7+'] as const).map((g) => (
                <button
                  ...
                  className={`py-2.5 rounded-xl font-bold transition-all ${
                    brandCountGauge === g ? 'bg-cyan-400 text-black font-black' : 'bg-surface-200 text-metal-300'
                  }`}
                >
                  {g} 个品牌
                </button>
          ...
          {/* Mode 05 & 06: Category & Foldable */}
          <div className="p-5 rounded-3xl bg-surface-100/90 border border-white/15 font-mono text-xs space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-cyan-400 font-bold text-[11px]">
                MODE 05 // 首发机型形态
              </span>
              <span className="text-metal-400 text-[10px]">FLAGSHIP 62%</span>
            </div>
              ...
              {(['FLAGSHIP', 'FOLDABLE', 'GAMING', 'MID-RANGE', 'BUDGET', 'CAMERA-FOCUSED'] as const).map((c) => (
                <button
                  ...
                  className={`py-2 rounded-lg font-bold text-[10px] transition-all ${
                    categoryPick === c ? 'bg-cyan-400 text-black' : 'bg-surface-200 text-metal-300'
                  }`}
                >
                  {c}
                </button>
            ...
            <div className="pt-2 border-t border-white/5 flex items-center justify-between">
              <div>
                <span className="text-white font-bold block">MODE 06: 10月会有全新折叠屏发布吗？</span>
                <span className="text-[10px] text-metal-400">以品牌官方发布会为准</span>
              </div>
              <div className="flex gap-1.5">
                <button
                  onClick={() => setFoldableYesNo('YES')}
                  className={`px-4 py-1.5 rounded-lg font-bold ${
                    foldableYesNo === 'YES' ? 'bg-lime-400 text-black' : 'bg-surface-200 text-metal-300'
                  }`}
                >
                  YES (58%)
                </button>
                <button
                  ...
                  className={`px-4 py-1.5 rounded-lg font-bold ${
                    foldableYesNo === 'NO' ? 'bg-red-500 text-white' : 'bg-surface-200 text-metal-300'
                  }`}
                >
                  NO
                </button>
          ...
          {/* Mode 07: Price Range */}
          <div className="p-5 rounded-3xl bg-surface-100/90 border border-white/15 font-mono text-xs space-y-2">
            <span className="text-cyan-400 font-bold text-[11px] block">
              ...
              {[
                ...
                <button
                  ...
                  className={`py-2 rounded-lg font-bold text-[11px] transition-all ${
                    priceRange === p.id ? 'bg-cyan-400 text-black font-black' : 'bg-surface-200 text-metal-300'
                  }`}
                >
                  {p.label}
                </button>
            ...
            <span className="text-[10px] text-metal-400 block pt-1">
      ...
      {/* 7. SIGNATURE GAME: OCTOBER TECH SUPER 8 (Section 15) */}
      <div className="p-6 sm:p-8 rounded-3xl bg-surface-100/95 border-2 border-cyan-400/60 backdrop-blur-xl shadow-[0_0_50px_rgba(0,229,255,0.25)] space-y-6 font-mono text-xs">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-white/10 gap-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded text-[10px] font-black bg-cyan-400 text-black uppercase">
            ...
            <p className="text-xs text-metal-300">
              一次性将 8 大科技发布推演维度合一封存上链 · 达成全中享最高 +2,500 XP 与【OCTOBER ORACLE】专属灵魂绑定勋章
            </p>
          </div>

          <div className="text-right">
            <span className="text-metal-400 text-[10px] block">推演进度</span>
            <span className="font-black text-2xl text-cyan-400">{super8Completed} / 8 项完成</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {[
            ...
            <div key={q.num} className="p-3.5 rounded-2xl bg-surface-200/90 border border-white/5 space-y-1">
              <div className="flex justify-between items-center text-[10px] text-metal-400">
      ...
      {/* 8. BUILD YOUR OCTOBER LAUNCH CALENDAR (Section 16 & 17) */}
      <div id="october-calendar" className="p-6 sm:p-8 rounded-3xl bg-surface-100/90 border border-white/15 backdrop-blur-xl shadow-glass-card space-y-6 font-mono text-xs">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`px-3 py-1.5 rounded-xl border text-[11px] font-bold ${
                showCalendarResults ? 'bg-lime-400 text-black border-lime-400' : 'bg-surface-200 text-metal-300 border-white/10'
              }`}
            >
        ...
        {!showCalendarResults && (
          <div className="space-y-2">
            <span className="text-metal-400 text-[11px] block">① 选择要排期的品牌：</span>
            <div className="flex flex-wrap gap-2">
              {['OPPO', 'vivo', 'Xiaomi', 'HONOR', 'OnePlus', 'Samsung', 'realme'].map((b) => (
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded-xl font-bold transition-all ${
                    selectedCalBrand === b ? 'bg-cyan-400 text-black shadow-sm' : 'bg-surface-200 text-metal-300 border border-white/10'
                  }`}
                >
                  {b}
                </button>
        ...
        {!showCalendarResults ? (
          <div className="space-y-2">
            <span className="text-metal-400 text-[11px] block">② 点击日期将【{selectedCalBrand}】绑定至对应日期：</span>
            <div className="grid grid-cols-7 gap-2 p-4 rounded-2xl bg-surface-50 border border-white/5">
              {['一', '二', '三', '四', '五', '六', '日'].map((w) => (
                <div key={w} className="text-center text-metal-400 font-bold text-[10px] pb-1">
                  周{w}
                </div>
              ))}

              {/* Offset for Oct 1 (Assume Thursday) */}
              ...
              {Array.from({ length: 31 }, (_, i) => i + 1).map((day) => {
                ...
                return (
                  <button
                    ...
                    className={`aspect-square rounded-xl p-1.5 flex flex-col justify-between text-left transition-all border ${
                      assignedBrand
                        ? 'bg-cyan-500/20 border-cyan-400 shadow-sm'
                        : 'bg-surface-200/90 border-white/5 hover:border-white/20'
                    }`}
                  >
                    <span className="text-[10px] font-bold text-metal-300">{day}</span>
                    {assignedBrand && (
                      <span className="text-[9px] font-black text-cyan-300 truncate bg-black/60 px-1 rounded">
                        {assignedBrand}
                      </span>
                    )}
                  </button>
          ...
          /* Calendar Result Mode (Section 17) */
          <div className="p-6 rounded-2xl bg-surface-200/90 border border-lime-400/40 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="p-4 rounded-xl bg-surface-100 border border-white/5 space-y-1">
                <span className="font-bold text-white text-sm block">OPPO</span>
                <div className="text-[11px] text-metal-300">
                  <span>用户推演：10月16日</span>
                  <span className="block text-white">官方发布：10月17日</span>
                </div>
                <span className="px-2 py-0.5 rounded text-[9px] bg-cyan-400/20 text-cyan-300 font-bold border border-cyan-400/30 inline-block mt-2">
                  NEAR HIT (相差1天) +300 XP
                </span>
              </div>

              <div className="p-4 rounded-xl bg-surface-100 border border-lime-400/40 space-y-1">
                <span className="font-bold text-white text-sm block">vivo</span>
                <div className="text-[11px] text-metal-300">
                  <span>用户推演：10月21日</span>
                  <span className="block text-white">官方发布：10月21日</span>
                </div>
                <span className="px-2 py-0.5 rounded text-[9px] bg-lime-400/20 text-lime-400 font-bold border border-lime-400/30 inline-block mt-2">
              ...
              <div className="p-4 rounded-xl bg-surface-100 border border-white/5 space-y-1">
                ...
                <div className="text-[11px] text-metal-300">
                  <span>用户推演：10月28日</span>
                  <span className="block text-white">官方结果：10月无发布会</span>
                </div>
                <span className="px-2 py-0.5 rounded text-[9px] bg-white/10 text-metal-400 font-bold inline-block mt-2">
                  MISS (未命中)
                </span>
              </div>
            </div>
        ...
        {!showCalendarResults && (
          <div className="flex justify-end">
            <button
              ...
              disabled={calendarLocked}
              className={`px-6 py-3 rounded-xl font-bold uppercase transition-all flex items-center gap-2 ${
                calendarLocked ? 'bg-cyan-400/20 text-cyan-300 border border-cyan-400/40' : 'bg-cyan-400 hover:bg-cyan-300 text-black shadow-sm'
              }`}
            >
      ...
      {/* 9. TECH IQ REPUTATION PROFILE & LEADERBOARD (Section 18 & 19) */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch font-mono text-xs">
        
        {/* Left 7 Cols: Tech IQ Profile (R.ON Tech IQ 811) */}
        <div className="lg:col-span-7 p-6 sm:p-8 rounded-3xl bg-surface-100/90 border border-cyan-400/40 backdrop-blur-xl shadow-glass-card space-y-5 flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-white/10">
              ...
              <div className="text-right">
                <span className="text-[10px] text-metal-400 block">全球科技榜</span>
                <span className="font-black text-xl text-white">#{user.globalTechRank}</span>
              </div>
            </div>

            <div className="flex items-center gap-6">
              <div className="font-black text-5xl sm:text-6xl text-cyan-400 tracking-tight">
                {user.techIQ}
              </div>
              <div className="text-metal-300 space-y-0.5">
                <span className="text-white font-bold block">极客宗师级评级 (Tech Oracle Master)</span>
                <span>连胜纪录：🔥 {user.techStreak} 场连续命中</span>
                <span className="block text-cyan-300 text-[10px]">击败全网 94.2% 的科技预测玩家</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 pt-2">
              <div className="p-2.5 rounded-xl bg-surface-200 border border-white/5">
                <span className="text-metal-400 text-[10px] block">品牌发布准确率</span>
                <span className="font-bold text-white text-sm">74%</span>
              </div>
              <div className="p-2.5 rounded-xl bg-surface-200 border border-white/5">
                <span className="text-metal-400 text-[10px] block">发布日期准确率</span>
                <span className="font-bold text-white text-sm">61%</span>
              </div>
              <div className="p-2.5 rounded-xl bg-surface-200 border border-white/5">
                <span className="text-metal-400 text-[10px] block">品牌对决胜率</span>
                <span className="font-bold text-cyan-400 text-sm">82%</span>
              </div>
              <div className="p-2.5 rounded-xl bg-surface-200 border border-white/5">
                <span className="text-metal-400 text-[10px] block">精确单日命中数</span>
                <span className="font-bold text-lime-400 text-sm">4 次 (Exact)</span>
              </div>
              <div className="p-2.5 rounded-xl bg-surface-200 border border-white/5">
                <span className="text-metal-400 text-[10px] block">产品类别准确率</span>
                <span className="font-bold text-white text-sm">68%</span>
              </div>
              <div className="p-2.5 rounded-xl bg-surface-200 border border-white/5">
                <span className="text-metal-400 text-[10px] block">SUPER 8 达成率</span>
                <span className="font-bold text-white text-sm">78%</span>
              </div>
            </div>
          </div>

          <div className="pt-3 border-t border-white/5 flex justify-between items-center text-[10px] text-metal-400">
            <span>综合 IQ 782 · F1 IQ 824 · 赛马 IQ 768 · Tech IQ 811</span>
            <span className="text-cyan-400">声誉全量链上认证</span>
          </div>
        </div>

        {/* Right 5 Cols: Tech Leaderboard (Section 19) */}
        <div className="lg:col-span-5 p-6 sm:p-8 rounded-3xl bg-surface-100/90 border border-white/15 backdrop-blur-xl shadow-glass-card space-y-4 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between pb-3 border-b border-white/10">
              ...
              <div className="flex bg-surface-200 p-0.5 rounded-lg text-[9px]">
                {(['GLOBAL', 'MALAYSIA'] as const).map((t) => (
                  <button
                    key={t}
                    onClick={() => setLeaderboardTab(t as any)}
                    className={`px-2 py-1 rounded ${leaderboardTab === t ? 'bg-cyan-400 text-black font-bold' : 'text-metal-400'}`}
                  >
                    {t}
                  </button>
                ))}
              ...
              {MOCK_LEADERBOARDS.tech.map((item) => (
                <div
                  ...
                  className={`p-2.5 rounded-xl flex items-center justify-between transition-all ${
                    item.isUser ? 'bg-cyan-400/20 border border-cyan-400 text-white font-bold' : 'bg-surface-200/80 text-metal-300'
                  }`}
                >
                  <div className="flex items-center gap-2">
                    <span className="w-6 font-mono text-[10px] text-metal-400">#{item.rank}</span>
                    <span className="text-xs">{item.name}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-cyan-400 font-bold">{item.techIQ} IQ</span>
          ...
          <div className="pt-2">
            <span className="text-[10px] text-metal-400 block text-center">
      ...
      {/* 10. B2B MONETIZATION: BRAND LAUNCH CAMPAIGN & SPONSORED POOL (Section 31 & 32) */}
      <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-[#0C121D] via-[#121A2A] to-[#0C121D] border-2 border-cyber-amber/50 backdrop-blur-xl shadow-glass-card space-y-5 font-mono text-xs">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-white/10 gap-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded text-[10px] font-black bg-cyber-amber text-black uppercase">
          ...
          <div className="p-3 rounded-2xl bg-cyber-amber/10 border border-cyber-amber/30 text-right">
            <span className="text-metal-400 text-[10px] block">品牌专项赞助奖池</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-[11px]">
          <div className="p-3 rounded-xl bg-surface-200 border border-white/5">
            <span className="text-metal-400 block text-[10px]">预测维度 01</span>
            <span className="text-white font-bold">精准发布日期与开幕时刻</span>
          </div>
          <div className="p-3 rounded-xl bg-surface-200 border border-white/5">
            <span className="text-metal-400 block text-[10px]">预测维度 02</span>
            <span className="text-white font-bold">首发核心卖点与芯片型号</span>
          </div>
          <div className="p-3 rounded-xl bg-surface-200 border border-white/5">
            <span className="text-metal-400 block text-[10px]">预测维度 03</span>
            <span className="text-white font-bold">官方首发起售价区间</span>
          </div>
          <div className="p-3 rounded-xl bg-surface-200 border border-white/5">
            <span className="text-white font-bold text-[10px] text-cyber-amber">获胜者特权</span>
            <span className="text-cyber-amber font-bold">发布会现场 VIP 门票 + 新机体验</span>
          </div>
        </div>
      </div>

      {/* 11. FUTURE TECH EXPANSION: TECH IS BIGGER THAN SMARTPHONES (Section 34 & 35) */}
      <div className="p-6 sm:p-8 rounded-3xl bg-surface-100/90 border border-white/15 backdrop-blur-xl shadow-glass-card space-y-6 font-mono text-xs">
        <div className="pb-4 border-b border-white/10 space-y-1">
          <div className="flex items-center gap-2 text-cyan-400 font-bold">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
          {[
            ...
            <div key={item.name} className="p-4 rounded-2xl bg-surface-200/60 border border-white/5 space-y-1 opacity-75">
              <span className="text-2xl">{item.icon}</span>
              <span className="font-bold text-white block pt-1">{item.name}</span>
              <p className="text-[10px] text-metal-400">{item.desc}</p>
              <span className="px-1.5 py-0.2 rounded text-[8px] bg-surface-300 text-metal-400 mt-2 inline-block">COMING SOON</span>
            </div>
          ))}
        </div>

        {/* Universal Engine Story Slogan (Section 35 & 40) */}
        <div className="p-6 rounded-2xl bg-gradient-to-r from-lime-400/10 via-cyan-400/10 to-cyber-blue/10 border border-cyan-400/30 text-center space-y-2">
      ...
      <AnimatePresence>
        {showShareModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
            ...
            >
              <div className="flex items-center justify-between pb-3 border-b border-white/10">
                <span className="font-bold text-cyan-400">MY OCTOBER TECH CALL</span>
                <button onClick={() => setShowShareModal(false)} className="text-metal-400 hover:text-white">✕</button>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-surface-200 border border-white/5 space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-cyan-400 font-bold">Tech IQ: {user.techIQ}</span>
                </div>
                <div className="space-y-1 text-metal-300 text-[11px]">
                  <div>• OPPO ➔ 10月16日 (OCT 15–21)</div>
                  <div>• vivo ➔ 10月21日 (OCT 15–21)</div>
                  <div>• HONOR ➔ 10月28日 (OCT 22–31)</div>
                </div>
                <div className="pt-2 text-[10px] text-metal-400">
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full py-3 rounded-xl bg-cyan-400 hover:bg-cyan-300 text-black font-bold uppercase tracking-wider"
                >
                ...
                <div className="flex gap-2">
                  {['WhatsApp', 'Telegram', 'Facebook', 'X (Twitter)'].map((p) => (
                    <button
                      ...
                      className="flex-1 py-2 rounded-xl bg-surface-200 hover:bg-surface-300 text-[10px] text-metal-300"
                    >
                      {p}
                    </button>
                  ))}
