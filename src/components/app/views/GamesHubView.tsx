...
export const GamesHubView: React.FC = () => {
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
      ...
      {/* Main 2 Active Game Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        
        {/* Card 1: Core Number Prediction */}
        <div className="p-8 rounded-3xl bg-surface-100/95 border-2 border-lime-400 backdrop-blur-2xl shadow-glow-lime/20 flex flex-col justify-between space-y-6 relative overflow-hidden group">
        ...
        <div className="p-8 rounded-3xl bg-surface-100/95 border-2 border-cyber-amber/60 backdrop-blur-2xl shadow-[0_0_50px_rgba(245,158,11,0.2)] flex flex-col justify-between space-y-6 relative overflow-hidden group">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="px-3 py-1 rounded-full text-xs font-mono font-black bg-cyber-amber text-black uppercase shadow-sm">
                ⭐ FEATURED // 特色推荐赛事
              </span>
              <span className="text-xs font-mono text-cyber-amber font-bold">
                50,000 USDT 赞助奖池
              </span>
            </div>
